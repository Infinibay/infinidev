...
- **raw-prior**: 10 preference choices; 0 errors; median latency 2.078s.
- **fast-autonomy**: 10 preference choices; 0 errors; median latency 1.330s.
- **quality-control**: 10 preference choices; 0 errors; median latency 1.921s.
...
- **quality-control** selected **A** — Show both names with their local precedents and recommend one without editing yet.; profile: `quality-control`; raw: `{"answer":"A"}`
...
- **quality-control** selected **C** — Give a likelihood-impact-fallback risk table.; profile: `quality-control`; raw: `{"answer":"C"}`
Observed pattern: models diverged.
...
- **quality-control** selected **A** — Give outcome, evidence, and one concise implication.; profile: `quality-control`; raw: `{"answer":"A"}`
Observed pattern: unanimous selection.
...
Observed responses:
- **raw-prior** selected **B** — Use the 3,000-token supersession-aware summary with anchors to every decisive turn.; profile: `none`; raw: `{"answer":"B"}`
- **fast-autonomy** selected **B** — Use the 3,000-token supersession-aware summary with anchors to every decisive turn.; profile: `fast-autonomy`; raw: `{"answer":"B"}`
