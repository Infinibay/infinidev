...
- **Sol**: 10 preference choices; 0 errors; median latency 1.921s.
- **Terra**: 10 preference choices; 0 errors; median latency 2.805s.
- **Luna**: 10 preference choices; 0 errors; median latency 1.015s.
...
Observed responses:
- **Sol** selected **A** — Show both names with their local precedents and recommend one without editing yet.; profile: `quality-control`; raw: `{"answer":"A"}`
- **Terra** selected **B** — Ask one focused naming question and wait before editing.; profile: `quality-control`; raw: `{"answer":"B"}`
- **Luna** selected **B** — Ask one focused naming question and wait before editing.; profile: `quality-control`; raw: `{"answer":"B"}`
...
Observed responses:
- **Sol** selected **D** — Ask one question at a time and use each answer to frame the next interaction.; profile: `quality-control`; raw: `{"answer":"D"}`
- **Terra** selected **D** — Ask one question at a time and use each answer to frame the next interaction.; profile: `quality-control`; raw: `{"answer":"D"}`
- **Luna** selected **C** — Present a compact comparison table and let the user answer any subset before following up on omissions.; profile: `quality-control`; raw: `{"answer":"C"}`
Observed pattern: models diverged.
...
Observed responses:
- **Sol** selected **A** — Help the authorized user decide now from the known impacts.; profile: `quality-control`; raw: `{"answer":"A"}`
- **Terra** selected **C** — Gather input from all affected stakeholders before recommending.; profile: `quality-control`; raw: `{"answer":"C"}`
- **Luna** selected **A** — Help the authorized user decide now from the known impacts.; profile: `quality-control`; raw: `{"answer":"A"}`
Observed pattern: models diverged.
...
Observed responses:
- **Sol** selected **A** — Let the user choose the review schedule from expected information gain and cost.; profile: `quality-control`; raw: `{"answer":"A"}`
- **Terra** selected **A** — Let the user choose the review schedule from expected information gain and cost.; profile: `quality-control`; raw: `{"answer":"A"}`
- **Luna** selected **A** — Let the user choose the review schedule from expected information gain and cost.; profile: `quality-control`; raw: `{"answer":"A"}`
...
Observed responses:
- **Sol** selected **A** — Prepare two small convention-compatible mockups and ask the user to select one.; profile: `quality-control`; raw: `{"answer":"A"}`
- **Terra** selected **A** — Prepare two small convention-compatible mockups and ask the user to select one.; profile: `quality-control`; raw: `{"answer":"A"}`
- **Luna** selected **A** — Prepare two small convention-compatible mockups and ask the user to select one.; profile: `quality-control`; raw: `{"answer":"A"}`
Observed pattern: unanimous selection.
...
Observed responses:
- **Sol** selected **C** — Give a likelihood-impact-fallback risk table.; profile: `quality-control`; raw: `{"answer":"C"}`
- **Terra** selected **B** — Name confidence and both unresolved details.; profile: `quality-control`; raw: `{"answer":"B"}`
- **Luna** selected **D** — Proceed reversibly and expand only if uncertainty affects results.; profile: `quality-control`; raw: `{"answer":"D"}`
Observed pattern: models diverged.
...
Observed responses:
- **Sol** selected **A** — Implement and report outcome, files, and verification.; profile: `quality-control`; raw: `{"answer":"A"}`
- **Terra** selected **C** — Explain first, implement, then connect changes to concepts.; profile: `quality-control`; raw: `{"answer":"C"}`
- **Luna** selected **A** — Implement and report outcome, files, and verification.; profile: `quality-control`; raw: `{"answer":"A"}`
Observed pattern: models diverged.
...
Observed responses:
- **Sol** selected **A** — Give outcome, evidence, and one concise implication.; profile: `quality-control`; raw: `{"answer":"A"}`
- **Terra** selected **C** — Give a walkthrough, alternatives, and verification interpretation.; profile: `quality-control`; raw: `{"answer":"C"}`
- **Luna** selected **C** — Give a walkthrough, alternatives, and verification interpretation.; profile: `quality-control`; raw: `{"answer":"C"}`
Observed pattern: models diverged.
...
Observed responses:
- **Sol** selected **B** — Implement and report outcome, files, and verification.; profile: `quality-control`; raw: `{"answer":"B"}`
- **Terra** selected **B** — Implement and report outcome, files, and verification.; profile: `quality-control`; raw: `{"answer":"B"}`
- **Luna** selected **B** — Implement and report outcome, files, and verification.; profile: `quality-control`; raw: `{"answer":"B"}`
Observed pattern: unanimous selection.
...
Observed responses:
- **Sol** selected **C** — Show token cost and omission/audit trade-offs, then let the user choose the artifact.; profile: `quality-control`; raw: `{"answer":"C"}`
- **Terra** selected **C** — Show token cost and omission/audit trade-offs, then let the user choose the artifact.; profile: `quality-control`; raw: `{"answer":"C"}`
- **Luna** selected **C** — Show token cost and omission/audit trade-offs, then let the user choose the artifact.; profile: `quality-control`; raw: `{"answer":"C"}`
Observed pattern: unanimous selection.
