...
SETTINGS_SECTIONS: dict[str, list[tuple[str, str, str]]] = {
    "LLM": [
        ("LLM_PROVIDER", "LLM provider", "select:ollama,llama_cpp,vllm,openai,anthropic,gemini,zai,zai_coding,kimi,kimi_coding,minimax,openrouter,qwen,openai_compatible"),
...
def _build_behavior_section() -> list[tuple[str, str, str]]:
    ...
    rows: list[tuple[str, str, str]] = [
        ...
        ("BEHAVIOR_LLM_PROVIDER", "Behavior judge provider (empty = reuse main)",
         "select:,ollama,llama_cpp,vllm,openai,anthropic,gemini,zai,zai_coding,kimi,kimi_coding,minimax,openrouter,qwen,openai_compatible"),
