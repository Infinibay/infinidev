...
COMMANDS = [
    ...
    ("/prompts", "List optional prompt capabilities and their effective state"),
    ("/prompts search", "Find capabilities by name or activation condition"),
    ("/prompts show", "Preview a capability's guidance before enabling it"),
    ("/prompts enable", "Enable a capability for future tasks"),
    ...
    ("/usage", "Show provider usage, quota and billing availability"),
    ...
    ("/ps", "List background tasks; select one to open its live output tab"),
    ("/bg", "List background tasks (alias for /ps)"),
    ("/tasks", "List background tasks (alias for /ps)"),
    ...
    ("/session", "Name this session; --resume manages prior sessions"),
