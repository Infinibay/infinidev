...
class LoopGuard:
    ...
    def check_progress_drift(
        ...
        notice = (
            ...
            "experiment phase, not a certainty gate: direct read_file has no "
            "call-count allowance, but appears only when exact target source is "
            "not live or was compacted by context pressure. Otherwise use the "
            "source already present. Make one reversible "
