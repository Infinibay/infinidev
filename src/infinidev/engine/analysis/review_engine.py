...
# Grounding + automated-check helpers live in dedicated modules. They are
# re-imported here so existing call sites — and tests that patch
# ``review_engine.collect_automated_checks`` or import the grounding
# helpers by name — keep working unchanged.
from infinidev.engine.analysis.review_grounding import (  # noqa: F401
    _FILE_HEADER_RE,
    _coerce_line,
    _quote_is_grounded,
    ...
    _WS_RE,
    _compute_issue_id,
    _extract_changed_files_from_summary,
)
from infinidev.engine.analysis.automated_checks import (  # noqa: F401
    collect_automated_checks,
    _compute_test_counts,
    _compute_file_symbols,
    _compute_hunk_stats,
    _HUNK_HEADER_RE,
)
