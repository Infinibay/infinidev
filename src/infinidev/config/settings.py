...
class Settings(BaseSettings):
    ...
    # LLM (via LiteLLM)
    LLM_PROVIDER: str = "ollama"  # Provider ID: ollama, llama_cpp, vllm, openai, openai_codex, anthropic, gemini, zai, zai_coding, kimi, minimax, openrouter, qwen, openai_compatible
